...
public class Map {
    ...
    private HashTableObject[] HashTable;
    ...
    public Map(int defSize) {
        ...
        HashTable = new HashTableObject[size];
        for (int i = 0; i < size; i++)
            HashTable[i] = new HashTableObject();
    }
    ...
    private void incSize() {
        HashTableObject[] newTab = new HashTableObject[size + inc];
